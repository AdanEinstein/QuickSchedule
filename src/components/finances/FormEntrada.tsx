...
const FormEntrada: React.FC = () => {
  const { ano, mes, setAno, setMes } = useFinance()
  ...
  return (
    <div className="w-100">
      <h2 className="text-light mb-4">Lance aqui sua entrada!</h2>
      <Form>
        <FloatingLabel className="mb-3 w-100" label="Descrição da entrada">
          <FormControl
